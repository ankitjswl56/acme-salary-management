...
- **Frontend component library**: MUI (`@mui/material` + `@mui/icons-material`
  + `@mui/x-charts` for the dashboard charts, Emotion styling engine). Adopted
  at the start of Phase 7 for the analytics dashboard; Phases 1–6's hand-rolled
  CSS views are deliberately not being retrofitted (time-boxed decision — see
